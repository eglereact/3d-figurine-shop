    ...
    >
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 ">
          <div className="bg-pink p-4 rounded-lg m-4">
            <div className=" transform  rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div className="bg-white pt-14 rounded-lg">
                <div className="sm:flex sm:flex-col sm:justify-center sm:items-center gap-10">
                  <div className=" absolute mx-auto z-10 -top-10 flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-full bg-pink sm:mx-0 sm:h-20 sm:w-20">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left ">
                    ...
                    >
                      ...
                      {deleteModal.data.name &&
                        deleteModal.data.role &&
                        `You are about to delete an account`}
                      {deleteModal.data.order_id &&
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 text-center p-4">
                        ...
                        <span className="uppercase text-red-500 font-bold">
                          ...
                          {deleteModal.data.order_id &&
                            `the order with ID ${deleteModal.data.order_id}`}
                        </span>
